...
public class Archer extends Character {
	...
	{
		/*
		 * case 1: trying to add health to full health unit or dead unit
		 * 	just return false
		 * case 2: trying to add health to unit with less than full health
		 * 			but health will go past max health 
		 * 	set to max health
		 * case 3: trying to decrease health below 0
		 * 	set to 0, setDead
		 * 
	...
	{
		/*
		 * case 1: trying to add mana to full mana unit or dead unit
		 * 	just return false
		 * case 2: trying to add mana to unit with less than full mana
		 * 			but mana will go past max
		 * 	set to max mana defined by the final variable
		 * case 3: trying to decrease mana below 0
		 * 	set to 0
		 * 
		 * case 2 and 3 returns true
		 */
	...
	{
		/*
		 *	case 1: adding strength takes it below 0
		 *		set to 0
		 *	otherwise, just add and then return true
		 */
		return false;
	}
	...
	{
		/*
		 *	case 1: adding defence takes it below 0
		 *		set to 0
		 *	otherwise, just add and then return true
		 */
		return false;
